    ...
    <div className='flex'>
        ...
        <form onSubmit={handleSubmit} className='w-full max-w-md bg-white p-8 rounded-lg border shadow-md' >
            <div className="flex justify-center mb-6">
                <h2 className="text-xl font-medium"> Aniakor</h2>
            </div>
            <h2 className='text-xl font-bold text-center mb-6'>Hey there! &#128075; </h2>
                <p className="mb-6 text-center"> Enter your name, email and password to Register</p>
                <div className="mb-4">
                ...
                <div className="mb-4">
                  ...
                  <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} className='w-full p-2 border rounded'placeholder='Enter your name'  required />
                </div>
                <div className="mb-4">
