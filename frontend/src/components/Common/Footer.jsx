    ...
    <footer className='border-t py-12 ml-8'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
            <div>
                ...
                <p className='font-medium text-md text-gray-600 mb-6'>Sign up and get 10% off your first order</p>
                {/* Newsletter form */}
                <form className='flex '>
        ...
        <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-300 pt-6'>
            <p className='text-center text-gray-500 text-sm tracking-tighter'>&lt;&lt;&copy; 2025, Aniakor. All Rights Reserved&gt;&gt;</p>
        </div>
    </footer >
  )
}
