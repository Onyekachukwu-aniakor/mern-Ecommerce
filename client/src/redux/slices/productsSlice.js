...
//Async Thunk to fetch product using a single ID
...
//Async Thunk to fetch similar products to given product Id
...
const productsSlice = createSlice({
    ...
    reducers : {
        setFilters : (state,action)=> {
            state.filters = {...state.filters, ...action.payload}; //merges new filters wit current one
        },
        clearFilters : (state)=>{
            state.filters = {
                category : '',
    ...
    extraReducers: (builder)=>{
        builder
        // handle fetching the products with filters
